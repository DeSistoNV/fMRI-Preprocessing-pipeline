...
##============root directory
root_dir = '/Data/tmp/brainstem_moco/'
...
default_params = {}
default_params['db'] = '/Data/tmp/test_db/mri.ichi.db'		 	##get subject and run information from this database
...
##==========subject : the arguments required by run_script to do work
subject = 'TJ'
experiment = 'brain.stem.resting.state.01'
fsl_preproc_params = {}
