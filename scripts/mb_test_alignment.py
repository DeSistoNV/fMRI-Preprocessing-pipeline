...
##============root directory
root_dir = '/Data/3T.musc/working_vols/'
...
default_params = {}
default_params['db'] = '/Data/3T.musc/databases/mri.ichi.db'		 	##get subject and run information from this database
...
##==============experiments
subject = 'TN'
experiment = 'hires.mb.coronal.big.repeatbility'
fsl_preproc_params = {}
...
subject = 'TN'
experiment = 'hires.stock.coronal.small.repeatibiltiy'
fsl_preproc_params = {}
fsl_preproc_params.update(make_subj_dir(root_dir, experiment, subject))
fsl_preproc_params.update(default_params)						
fsl_preproc_params['experiment'] = experiment
...
subject = 'TN'
experiment = 'hires.mb.coronal.small.repeatability'
fsl_preproc_params = {}
fsl_preproc_params.update(make_subj_dir(root_dir, experiment, subject))
fsl_preproc_params.update(default_params)						
fsl_preproc_params['experiment'] = experiment
...
subject = 'TN'
experiment = 'hires.mb.axial.big.repeatability'
fsl_preproc_params = {}
fsl_preproc_params.update(make_subj_dir(root_dir, experiment, subject))
fsl_preproc_params.update(default_params)						
fsl_preproc_params['experiment'] = experiment
