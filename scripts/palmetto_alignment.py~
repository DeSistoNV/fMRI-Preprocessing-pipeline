...
##============root directory
root_dir = '/scratch/tnaselaris/results/'
...
run_script = '/home/tnaselaris/code/Python/nipype_mri/scripts/fsl_preproc_go.py'    
repo = '/scratch/tnaselaris/pbs.reports/'        			#repo ~ a path to a place where the script argument data, the .sh script, and stdout and stderr go
user = 'tnaselaris'

##===========general fsl_preproc options that won't change across subjects
default_params = {}
default_params['db'] = '/home/tnaselaris/Data/7T.cmrr/databases/mri.palmetto.db'		 	##get subject and run information from this database
