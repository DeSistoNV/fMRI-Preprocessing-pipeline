...
##============root directory
root_dir = '/Data/tmp/' #NOTE: CHANGE THIS!
...
run_script = '/home/tnaselar/code/Python/nipype_mri/scripts/fsl_preproc_go.py'    #NOTE: CHANGE THIS!
repo = '/Data/tmp/'+'pbs.reports/'        		#NOTE: CHANGE THIS!! repo ~ a path to a place where the script argument data, the .sh script, and stdout and stderr go
user = 'tnaselar'

##===========general fsl_preproc options that won't change across subjects
default_params = {}
default_params['db'] = '/musc.repo/mri/3T.musc/databases/mri.ichi.db'		 	##get subject and run information from this database
...
default_params['moco_only'] = True							##should just only do motion correction
...
##==========subject KL
#subject = 'KL'
#experiment = 'single.object.1000.med.font'
#fsl_preproc_params = {}
...
##==================TN
subject = 'TN'
experiment = 'single.object.1000.med.font'							##Data will be in a folder named this
fsl_preproc_params = {}
fsl_preproc_params.update(make_subj_dir(root_dir, experiment, subject))			##This determines where the data will be put
fsl_preproc_params.update(default_params)						
fsl_preproc_params['experiment'] = experiment
fsl_preproc_params['sess_list'] = []							        ##NOTE: Leave empty to use ALL available sessions
fsl_preproc_params['run_list'] = []						         	##NOTE: Leave empty to use ALL available runs
